...
export default class PlayerCard extends React.Component {
  ...
  componentDidMount() {
    ...
    mainLoop: for (let preferredPosition of this.props.player.positions) {
      ...
      // Support for 2 central midfilders
      if (preferredPosition === "MDC" || preferredPosition === "MOC") {
        if (this.props.occupiedPositions.find(e => e === "MC1") === undefined) {
          preferredPosition = "MC1"
        } else {
          preferredPosition = "MC2"
        }
      }
