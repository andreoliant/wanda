...
// Import dependencies
// SERVONO PER EXPORT DI IMMAGINE
...
export default class App extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      playersIndex: require('./data/index_team.json'),
      // MEMO: QUI HO INSERITO UNA SUBLIST DELL'INDICE GENERALE
  ...
  // QUESTO GESTISCE SOLO ESORTAZIONE SCREENSHOT
  // createCanvas = () => {
  //   // Loading message
